...
<div id="content" class="clearfix">
	<div id="content_wrap" class="container_12">
		...
		<?php $term = wp_get_post_terms($post->ID, 'cursos', 'name' ); $curso = $term[0]->slug; ?>
			<?php  $custom_fields = get_post_custom($post->ID); $agenda_text =  $custom_fields['agenda_text'][0]; $fotos_text =  $custom_fields['fotos_text'][0]; $videos_text =  $custom_fields['videos_text'][0]; $depoimentos_text =  $custom_fields['depoimentos_text'][0];?>
