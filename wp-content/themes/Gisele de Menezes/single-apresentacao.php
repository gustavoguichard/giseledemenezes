...
<?php  $custom_fields = get_post_custom($post->ID); $agenda_text =  $custom_fields['agenda_text'][0]; $fotos_text =  $custom_fields['fotos_text'][0]; $videos_text =  $custom_fields['videos_text'][0]; $parceiros_text =  $custom_fields['parceiros_text'][0]; $links_text =  $custom_fields['links_text'][0]; $depoimentos_text =  $custom_fields['depoimentos_text'][0]; $cursos_text =  $custom_fields['cursos_text'][0]; $banner_conteudo =  $custom_fields['banner_conteudo'][0];?>

<?php $term = wp_get_post_terms($post->ID, 'sessao', 'name' ); $sessao = $term[0]->slug; ?>
<?php $taxonomy = "&sessao=$sessao";?>
<?php require_once('loops/loop-banner.php'); ?>
